    ...
    <section id="competitors" className="px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-neutral-600">
          Comprehensive key performance indicators and business metrics analysis
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg border border-neutral-200">
          ...
          <div className="text-3xl font-bold mb-2">${data?.averageCac}</div>
        ...
        <div className="bg-white p-6 rounded-lg border border-neutral-200">
          ...
          <div className="text-3xl font-bold mb-2">{data?.averageROI}%</div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-neutral-50 rounded">
              ...
              <div className="flex items-center">
                <span className="font-semibold">${data?.averageCpm}</span>
            ...
            <div className="flex justify-between items-center p-3 bg-neutral-50 rounded">
              ...
              <div className="flex items-center">
                <span className="font-semibold">{data?.clickThroughRate}%</span>
